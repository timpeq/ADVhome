> **Archived 2026-09-12. Not maintained.** This was ADVhome's phase-based
> roadmap, the project's task list from the commit that created it (`290cc1a`,
> 2026-09-06) to its last edit (`38e3e0b`, 2026-09-11). Its open items moved to
> [TODO.md](../../TODO.md) as numbered tasks `T-01` to `T-37`; the ticked items
> here are the record of what was built in the first week. For its history
> before the move: `git log --follow docs/archive/2026-09-12-roadmap.md`.
